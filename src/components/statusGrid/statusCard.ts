          ...
          let memChart = new Chart(memChartCanvas[0], {
            ...
            data: {
                datasets: [{
                    data: [
                        this.node.used_ram, 
                        (this.node.total_ram - this.node.used_ram)
                    ],
                    backgroundColor: [
            ...
            options: {
                elements: {
                    center: {
                        text: ['Mem', Math.round((this.node.used_ram / this.node.total_ram) * 100) + '%'],
                ...
                title: {
                    display: false,
                    text: this.getChartTitle(this.node.total_ram),
                    fontSize: 15,
                    position: 'bottom'
                }
              }
          ...
          let diskChart = new Chart(diskChartCanvas[0], {
            ...
            data: {
                datasets: [{
                    data: [
                        this.node.used_disk, 
                        (this.node.total_disk - this.node.used_disk)
                    ],
                    backgroundColor: [
            ...
            options: {
                elements: {
                    center: {
                        text: ['Disk', Math.round((this.node.used_disk / this.node.total_disk) * 100) + '%'],
                ...
                title: {
                    display: false,
                    text: this.getChartTitle(this.node.total_disk),
                    fontSize: 15,
                    position: 'bottom'
                }
              }
